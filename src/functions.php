...
function html5blank_nav()
{
    ...
    array(
        ...
        'link_before'     => '',
        'link_after'      => '',
        'items_wrap'      => '<ul class="stripped-nav">%3$s</ul>',
        'depth'           => 0,
        'walker'          => ''
        )
    );
...
function footer_design_menu_nav()
{
    wp_nav_menu(
    array(
        'theme_location'  => 'footer-design-menu',
        'menu'            => '',
        'container'       => 'div',
        'container_class' => 'main-nav',
        'container_id'    => '',
...
function footer_business_menu_nav()
{
    wp_nav_menu(
    array(
...
function footer_about_menu_nav()
{
    wp_nav_menu(
    array(
...
function footer_social_menu_nav()
{
    wp_nav_menu(
    array(
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // Conditionizr
            wp_register_script('conditionizr', get_template_directory_uri() . '/bower_components/conditionizr/dist/conditionizr.min.js', array(), '4.5.0');

	    // Velocity
            wp_register_script('velocity', get_template_directory_uri() . '/js/velocity.min.js', array(), '1.2.3');
...
function html5blank_styles()
{
    if (HTML5_DEBUG) {
        ...
        // Custom CSS
        wp_register_style('html5blank', get_template_directory_uri() . '/style.css', '1.0');
...
add_action('upload_mimes', 'cc_mime_types'); // Allow svg uplod
